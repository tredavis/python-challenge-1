...
while place_order:
    ...
    while True:
        ...
        keep_ordering = input("Would you like to keep ordering? (Y)es or (N)o ").lower() # making it lowercase no matter what the user inputs, this fulfills the requirement of the assignment
        ...
        match keep_ordering.lower():
                ...
                case "n":
                    ...
                    break
                case _:
                    print('Please try again and input "Y" or "N".')
...
for item in order:
    ...
    num_item_spaces = 24 - len(str(item_name)) + 2
